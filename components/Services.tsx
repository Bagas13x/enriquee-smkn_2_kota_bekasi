...
export default function Services() {
    ...
    return (
        <>
        <div id="services">
            <div className="relative overflow-hidden bg-black min-h-screen px-4 py-1 md:py-6">
                ...
                <div className="mt-3 md:mt-20 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    {(() => {
