...
export default function Contact(){
    ...
    return(
        <section>
            {/* judul */}
            <div>
                <h2 className="text-center text-5xl md:text-7xl font-black mb-16 ">Wujudkan ide anda <br />bersama kami.</h2>
            </div>
            {/* isi */}
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-4 md:p-8">
                <a href="https://maps.app.goo.gl/4waXKrP1qgJcv7L77"
                target="_blank"
                rel="noopener noreferrer"
                className="relative rounded-[25px] overflow-hidden shadow-2xl h-[600px] group cursor-pointer block animate-slide-in-up hover:sahdow-3xl transition-shadow duration-300">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1982.6476947100011!2d106.99074866803045!3d-6.355796060368484!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698c22161d4051%3A0x7a0a35b288779341!2sSMKN%202%20Kota%20Bekasi!5e0!3m2!1sen!2sid!4v1770349340982!5m2!1sen!2sid" className="w-full h-full" style={{border: "none"}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black rounded-[25px] pointer-events-none"></div>
                ...
                <form className="flex flex-col gap-6">
                    <div>
                        ...
                        <input type="text" placeholder="Masukkan nama lengkap Anda" className="w-full px-4 py-3 border-b-2 border-gray-300 focus:outline-none focus:border-b-black transition duration-200"></input>
                    </div>
                    {/* dropdown */}
                    <div>
                    ...
                    <div>
                        ...
                        <input type="email" placeholder="Masukkan email Anda" className="w-full px-4 py-3 border-b-2 border-gray-300 focus:outline-none focus:border-b-black transition duration-200"></input>
                    </div>
                    {/* deskripsi order */}
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">Deskripsi Proyek</label>
                        <textarea placeholder="Jelaskan detail proyek Anda..." className="w-full px-4 py-3 border-b-2 border-gray-300 focus:outline-none focus:border-b-black transition duration-200 resize-none h-32"></textarea>
                    </div>

                    <button type="submit" className="flex items-center group mt-auto">
