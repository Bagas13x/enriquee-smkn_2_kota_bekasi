...
export default function About() {
  ...
  return (
    <div className="bg-white" id="about">
      <div className="max-w-350 mx-auto px-6 md:px-12 lg:px-16 py-8 md:py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-md row-span-2">
            <Image
              ...
              width={1200}
              height={1000}
              className="w-full h-100 md:h-125 lg:h-full object-cover"
              priority
            />
          </div>
          ...
          <div className="text-gray-800 text-sm md:text-base leading-relaxed text-justify">
            <p>
              Dari detail sederhana sampai animasi unik yang interaktif, kami
              bantu brand kamu tampil lebih ekspresif. Visal yang bergerak,
              komunikatif, dan punya identitas sendiri.
            </p>
          </div>
        </div>
      </div>
